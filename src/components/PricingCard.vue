<template>
  ...
  <!-- <div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center border border-gray-200"> -->
    ...
    <p class="mt-4 text-2xl font-extrabold">{{ price }}<span class="text-base font-normal">/month</span></p>
    <p v-if="popular" class="text-custom-purple-button font-semibold mt-1">Most popular</p>
    <button class="mt-4 py-2 px-6 bg-custom-purple-button text-white rounded-full hover:bg-gray-800">Choisir</button>
    ...
    <p v-if="current" class="mt-4 text-custom-purple font-semibold">Plan actuel</p>
  </div>
</template>
